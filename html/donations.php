...
<html>
<head>
<title>Hope - Cause Donation</title>
...
$donations = mysql_query("SELECT persons.FirstName, persons.LastName, paymentdetails.DonorID, donations.Amount, donations.Date FROM persons, paymentdetails, donations WHERE paymentdetails.PaymentDetailID = donations.PaymentDetailID And paymentdetails.DonorID = persons.PersonID And CauseID=" . $causeid);
