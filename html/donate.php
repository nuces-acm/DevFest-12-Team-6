...
<body>
	...
	<div id="wrapper">																																																																																																																																																																																																																																<div class="inner_copy"><a href="http://www.bestfreetemplates.info/flash.php">free flash templates</a><a href="http://www.beautifullife.info/web-design/15-best-free-website-builders/">best free website builders</a></div>
		<div class="bigblock">
			<img src="images/donateAmount.jpg" alt="" width="696" height="26" /><br />
			<div>
<?php
$con = mysql_connect("localhost:3306","root","root");
if (!$con)
...
<form method="post" action="adddonation.php?causeid=<?php echo $causeid ?>">
    <b>Amount: </b> <input type="text" name="txtAmount" /> Rs
    <br />
	<br  />
    <input style="margin-left:50px;" type="submit" value="Donate" />
</form>
